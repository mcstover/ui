...
// We could also potentially include files from styleguide
// @import 'styleguide/source/css/scss/app/header.scss';
// @import 'styleguide/source/css/scss/_font-vars.scss';

// TEMP VARS from styleguide/source/css/scss/app/header.scss
$header-height: rem-calc(64);
$header-height-small: rem-calc(45);
$selected-color: #a9a9a9;
$level-one-background: $white;
$level-two-background: #f5f5f5;
$level-three-background: #e6e6e6;

// TEMP VARS from styleguide/source/css/scss/_font-vars.scss
$top-nav-font-size: rem-calc(21);
$top-nav-line-height: rem-calc(21);
$top-nav-font-reduction: rem-calc(3);
